    	...
    	<div class="row">
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    <!-- Main menu -->
                    <li><a href="index.php"><i class="glyphicon glyphicon-home"></i> Panelim</a></li>
                    <li class="current"><a href="tables.php"><i class="glyphicon glyphicon-list"></i> Tablo</a></li>
                    <li><a href="buttons.php"><i class="glyphicon glyphicon-record"></i> Buton</a></li>
                    <li><a href="editors.php"><i class="glyphicon glyphicon-pencil"></i> Düzenle</a></li>
                    <li><a href="forms.php"><i class="glyphicon glyphicon-tasks"></i> Formlar</a></li>
                </ul>
             </div>
		  </div>
		  <div class="col-md-10">
